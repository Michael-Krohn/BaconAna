...
namespace baconhep
{
  class TAddJet : public TObject
  {
    public:
      ...
      SDmassCorr(0),UncorrectedE(0),
      tau1(-1), tau2(-1), tau3(-1), tau4(-1)
      {}
      ~TAddJet(){}
      
      unsigned int index;                                                   // index in original jet collection
      double E, pT, eta, phi, SDmass, PrunedMass, lsfC_3_sj1_pt, lsfC_3_sj1_eta, lsfC_3_sj1_phi, lsfC_3_sj1_m, lsfC_3_sj2_pt, lsfC_3_sj2_eta, lsfC_3_sj2_phi, lsfC_3_sj2_m, lsfC_3_sj3_pt, lsfC_3_sj3_eta, lsfC_3_sj3_phi, lsfC_3_sj3_m, lmdCInc, lmdC_2, lmdC_3, lmdC_4, lsfCInc, lsfC_2, lsfC_3, lsfC_4, maxSubJetCSV, SDmassCorr, UncorrectedE;
